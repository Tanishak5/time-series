...
if ticker:
    ...
    if not data_frame.empty:
        ...
        train_data_frame = data_frame #CURRENTLY THERE IS NO TEST TRAIN SPLIT BUT THERE WILL BE
        ...
        #PREDICTIONS
        future_frame = model.make_future_dataframe(periods = period_predictions)
        future_frame['rsi'] = 0
        ...
        ax.plot(train_data_frame['ds'], np.exp(train_data_frame['y']), label="Actual", color = "blue")
        ...
        actual = np.exp(train_data_frame['y'])
